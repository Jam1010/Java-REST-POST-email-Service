 ...
 *
 */
public class SendGridEmailProviderIntegrationTest {

	@Test
	public void testSendmail() throws JsonParseException, JsonMappingException, IOException {
		EmailProvider provider = SendGridEmailProvider.getInstance();
		Email email = new ObjectMapper().readValue("{\"to\":\"sriramkeerthy@gmail.com\","
				+ "\"to_name\":\"sriram\","
				+ "\"from\":\"noreply@uber.com\","
				+ "\"from_name\":\"Uber\","
				+ "\"subject\":\"Testing\","
				+ "\"body\":\"<h1>Test SendGrid email provider</h1>\"}", Email.class);
